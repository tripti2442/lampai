...
export default function Practicemobile() {
    ...
    const myfunc = () => {
        // Implement functionality for myfunc
    };
    ...
    return (
        <div className="flex-col justify-center items-center p-2">
            ...
            <div className="flex-col space-x-6 space-y-6 mr-6 ">
                ...
                <div className=" bg-white h-48 rounded-2xl ml-7 mt-6">
                    ...
                    <div className="assess flex bg-purple-300 p-4 rounded-b-2xl" style={{ boxShadow: "0px 0px 2px #a21caf, 0 0 25px #f0abfc, 0 0 5px #f5d0fe" }}>
                        <button id="read1" className="read ml-8 flex space-x-2" onClick={myfunc}><img src={practice} className='ml-1 mt-auto mb-2' alt="Practice" /><p>Practice</p></button>
                ...
                <div className=" bg-white h-48 rounded-2xl">
                    ...
                    <div className="assess flex bg-purple-300 p-4 rounded-b-2xl " style={{ boxShadow: "0px 0px 2px #a21caf, 0 0 25px #f0abfc, 0 0 5px #f5d0fe" }}>
                        <button id="read2" className="read ml-8 flex space-x-2" onClick={myfunc2}><img src={practice} className='ml-1 mt-auto mb-2' alt="Practice" /><p>Practice</p></button>
                        <img src={code} className="h-20 w-20 rounded-full ml-auto mr-6 " alt="code" />
                    </div>
                </div>
                
                {showAdditionalDiv && <Codingmobile />}
                <div className=" bg-white h-48 rounded-2xl">
                    <p className="p-4 font-bold text-lg">
                        <span>Case</span><br />Study
                    </p>
                    <div className="assess flex bg-purple-300 p-4 rounded-b-2xl" style={{ boxShadow: "0px 0px 2px #a21caf, 0 0 25px #f0abfc, 0 0 5px #f5d0fe" }}>
                        <button id="read3" className="read ml-8 flex space-x-2" onClick={myfunc}><img src={practice} className='ml-1 mt-auto mb-2' alt="Practice" /><p>Practice</p></button>
                ...
                <div className=" bg-white h-48 rounded-2xl">
                    ...
                    <div className="assess flex bg-purple-300 p-4 rounded-b-2xl" style={{ boxShadow: "0px 0px 2px #a21caf, 0 0 25px #f0abfc, 0 0 5px #f5d0fe" }}>
                        <button id="read4" className="read ml-8 flex space-x-2" onClick={myfunc}><img src={practice} className='ml-1 mt-auto mb-2' alt="Practice" /><p>Practice</p></button>
