...
export default function Right() {
  ...
  return (
    <div >
      <div className="flex-col w-fit ml-auto mt-0 border-2 rounded-xl px-6 bg-white">
        ...
        <div className="flex justify-center p-6 pt-2">
          <div className='w-44 h-24 p-4 border-r-2 pl-0 text-xl font-bold'><p>Badges</p></div>
          <div className='w-44 h-24 p-4 text-xl font-bold'><p>Focussed Areas</p></div>
        </div>
      </div>
      <Image/>
      </div>
